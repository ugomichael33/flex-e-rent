  ...
  return (
    <div className='w-full mx-auto'>
            <div>
              ...
              <p className='input-section mx-auto mt-4'>By submitting this form, I agree to receive emails, telephone calls, promotional offers,
                 marketing materials and other communications from Flexerent(including its subsidiaries, 
                 affiliates, agents, and assigns) (“Flexerent”) about its products and services. 
                 I understand that I can withdraw my authorization at any time. 
